...
Defined in: [nvimage/utils.ts:206](https://github.com/thewtex/niivue/blob/main/packages/niivue/src/nvimage/utils.ts#L206)
...
Defined in: [nvimage/utils.ts:205](https://github.com/thewtex/niivue/blob/main/packages/niivue/src/nvimage/utils.ts#L205)
...
```ts
optional zarrCenterMM: [number, number, number];
```
...
```ts
optional zarrConvertUnits: boolean;
```
...
```ts
optional zarrMaxVolumeSize: number;
```

Defined in: [nvimage/utils.ts:209](https://github.com/thewtex/niivue/blob/main/packages/niivue/src/nvimage/utils.ts#L209)
